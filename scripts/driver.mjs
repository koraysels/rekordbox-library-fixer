// Playwright REPL driver for Rekordbox Library Manager (macOS Electron)
...
console.log('Rekordbox Library Manager driver — "help" for commands, "launch" to start');
rl.prompt();
